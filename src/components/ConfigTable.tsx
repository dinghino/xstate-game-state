...
import { DeviceGamepad2, Icon, Keyboard, Mouse } from "tabler-icons-react";
import { Center, createStyles, Kbd, Table, Text } from "@mantine/core";
import type {
  FinalizedInputs,
  InputMapping,
  TControllerType
...
const Icons: { [key in TControllerType]: Icon } = {
  keyboard: Keyboard,
  mouse: Mouse
